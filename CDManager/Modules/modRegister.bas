...
frmMain.RegAccess.Path = "Software\Dream Works Technologies\CDManager 2004"
If Not frmMain.RegAccess.KeyExists Then
    ...
    frmMain.RegAccess.Data = encrypt_pass("1123-2002-4432-5654-8597-0031-3345")
    frmMain.RegAccess.DataType = REG_SZ
    frmMain.RegAccess.SetValue
